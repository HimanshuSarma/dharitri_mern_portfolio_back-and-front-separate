export const editCart = (payload, navigateHandler, getCartItemQty, setMessageHandler, operation) => {
    return async (dispatch, getState) => {
        ...
        try {
            ...
            const editCartRequest = await fetch('http://localhost:5000/cart', {
                method: 'PATCH',
                headers: {
...
export const getCart = () => {
    return async (dispatch, getState) => {
        ...
        try {
            ...
            const getCartReq = await fetch('http://localhost:5000/cart', {
                method: 'GET',
                credentials: 'include'
            })
...
export const getCartQty = (productID) => {
    return async (dispatch, getState) => {
        ...
        try {
            const getCartProductReq = await fetch(`http://localhost:5000/get-cart-item/${productID}`, {
                method: 'GET',
                credentials: 'include'
            })
...
export const deleteCartItem = (productID, setMessageHandler) => {
    return async (dispatch, getState) => {
        ...
        try {
            const deleteCartItemReq = await fetch(`http://localhost:5000/cart/${productID}`, {
                method: 'DELETE',
                credentials: 'include'
            })
