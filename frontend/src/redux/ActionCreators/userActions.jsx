export const createUserAction = (formState, changeUserDetailsValidity, changeWillNavigate) => {
    return async (dispatch, getState) => {
        try {
            ...
            const createUserReq = await fetch('http://localhost:5000/signup', {
                method: 'POST',
                headers: {
...
export const loginUserAction = (loginCredentials, setIsLoggedIn) => {
    return async (dispatch, getState) => {
        ...
        try {
            const loginUserRequest = await fetch('http://localhost:5000/login', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
...
export const userLogout = (setIsLogoutLoading) => {
    return async (dispatch, getState) => {
        ...
        try {
            const userLogoutReq = await fetch('http://localhost:5000/logout', {
                credentials: 'include'
            })
...
export const checkUserLogin = () => {
    return async (dispatch, getState) => {
        try {
            ...
            const checkUserLoginReq = await fetch('http://localhost:5000/check-login', {
                credentials: 'include'
            })
...
export const getUserShippingAddresses = () => {
    return async (dispatch, getState) => {
        try {
            ...
            const getUserAddressesReq = await fetch('http://localhost:5000/user-addresses', {
                method: 'GET',
                credentials: 'include'
            });
...
export const getUserShippingAddress = () => {
    return async(dispatch, getState) => {
        try {
            ...
            const getUserShippingAddressReq = await fetch('http://localhost:5000/user-address', {
                method: 'GET',
                credentials: 'include'
            });
...
export const updateUserShippingAddress = (payload, newAddress) => {
    return async(dispatch, getState) => {
        try {
            ...
            const addUserAddressReq = await fetch('http://localhost:5000/update-user-address', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
